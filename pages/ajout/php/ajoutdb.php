...
//Contrôle des erreurs en cas de variable vide
if($nom == "" OR $adresse == "" OR $date == "" OR $heure== "") {
    $erreur = TRUE;
    echo "<h2>Une erreur est survenue dans la saisie du formulaire</h2>";
    echo "<a href='../index.php'>Retour vers Ajout de match</a><br>";
    echo "<a href='../../../index.php'>Retour vers Les PONEYS</a>";
}
...
if(!$erreur) {
    ...
    $message = "La cheffe a ajouté un match contre {$nom} le {$jourSemaine} {$jour} à {$heure} qui se jouera à {$adresse}".FOOTERMAIL;
